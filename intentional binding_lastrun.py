...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='D:\\Documents\\Desktop\\lab in psychology\\intentional binding_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text = visual.TextStim(win=win, name='text',
        text='report the delay betweem the keypress and the beep sound (0-999); click submit after entering the value',
        font='Arial',
    ...
    trials = data.TrialHandler(nReps=40.0, method='random', 
        ...
        trialList=data.importConditions('D:/Documents/Downloads/ib_cons.xlsx'),
